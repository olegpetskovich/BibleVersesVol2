...
class DailyVersesDBHelper(context: Context) {
    ...
    fun loadDailyVersesList(): Single<ArrayList<DailyVerseModel>> {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                val dailyVerse = DailyVerseModel(id, bookNumber, chapterNumber, verseNumber)
    ...
    fun addDailyVerse(dailyVerse: DailyVerseModel) {
        cv.put("book_number", dailyVerse.bookNumber)
        cv.put("chapter_number", dailyVerse.chapterNumber)
        cv.put("verse_number", dailyVerse.verseNumber)
